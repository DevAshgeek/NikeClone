...
const Footer = () => {
  return (
    <footer className="max-container">
            ...
            <div key={sectionlink}>
              ...
              <ul>
                {sectionlink.links.map((link) => (
                  <li
                    key={link.name}
                    className="text-white-400 font-montserrat text-base leading-normal hover:text-coral-red cursor-pointer"
                  >
      ...
      <div className="flex justify-center items-center gap-12 text-white mt-24 max-sm:flex-col max-sm:gap-4">
